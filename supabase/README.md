...
Без наката `20260513120000_catalog_rear_delt_core.sql` на проект в приложении **пустой список упражнений в группе «Кор»** (в таблице не будет строк с `muscle_group = 'core'`).
